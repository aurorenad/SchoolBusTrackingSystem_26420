...
public class DriverController {
    ...
    public ResponseEntity<String> saveDriver(@RequestBody Driver driver) {
        ...
        if ("Driver saved successfully".equals(response)) {
    ...
    @GetMapping("/statistics/{driverEmail}")
    public ResponseEntity<?> getDriverStatistics(@PathVariable String driverEmail) {
        try {
            Map<String, Object> stats = driverService.getDriverStatistics(driverEmail);
